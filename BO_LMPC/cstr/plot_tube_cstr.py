...
v_tvbo = np.load('./vertices/tvbo_1/vertices_18.npy', allow_pickle=True)
...
tube_index_lmpc = [0, 1, 2]
tube_index_tvbo = [0, 1, 2]
...
uv_tvbo = np.load('./vertices/tvbo_1/Kxs_18.npy', allow_pickle=True)
